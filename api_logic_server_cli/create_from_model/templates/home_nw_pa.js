const sla_doc = '<div class="MuiTypography-root"><center><h1>Welcome to API Logic Server - Sample</h1></center><br>' +
    ...
    '<br><h2>Resources</h2>' +
    '<ul>' +
    '<li><a class="custom" rel="nofollow" href="https://github.com/valhuber/ApiLogicServer/wiki/Admin-Tour" target="_blank">Tutorial</a></li>' +
    '<li><a class="custom" rel="nofollow" href="https://apilogicserver.pythonanywhere.com/api" target="_blank">Swagger</a></li>' +
