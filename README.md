...
> ** Important: ** we are starting to see Python / Flask AppBuilder Certificate issue - see [Troubleshooting](https://github.com/valhuber/ApiLogicServer/wiki/Troubleshooting#certificate-failures)
