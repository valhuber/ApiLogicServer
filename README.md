...
After you've explored the [sample](https://github.com/valhuber/ApiLogicServer/wiki/Sample-Database) (e.g., find Swagger at [localhost:5000](http://localhost:5000)), try different databases: [run our tests using Dockerized Databases](https://github.com/valhuber/ApiLogicServer/wiki/Testing), and then try your own database.
...
| 4. [**Customizable**](#3-customize) | Custom Data Model, Endpoints, Logic | Customize and run <br>Re-creation *not* required | PyCharm <br> VS Code ... |
