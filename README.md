...
> Already installed?  Upgrade to the latest (4.01.00): ```docker pull apilogicserver/api_logic_server``` (you may need to [rebuild your container](https://github.com/valhuber/ApiLogicServer/wiki#apilogicserver-container-upgrades)).
...
```
   ...
   > __Alert:__ we have encounted a bug in pip-install version for Windows.  Please use `pip install ApiLogicServer==4.0.12`.  You can [track this issue here](https://github.com/valhuber/ApiLogicServer/issues/32)
